...
- 登錄到 [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx)。
...
分數報告可以從以下位置存取 [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx)。

- 登錄到 [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx)。
- 選擇「查看我的分數報告」。您可以從這裡儲存和列印成績單。
- 您的考試結果(通過或失敗)將轉發給 Microsoft 進行處理。
- 考試結束後，您應該刪除所有可執行文件和輔助文件，包括“Pearson VUE 安全瀏覽器”圖標。要從桌面上刪除該圖標，請右鍵單擊該圖標，選擇“刪除”，然後選擇“是”。
- **[卸載 Pearson VUE 安全瀏覽器的可執行文件](https://windows.microsoft.com/en-us/windows7/uninstall-or-change-a-program)**。
...
要開始考試，請登錄  [your certification dashboard](https://www.microsoft.com/learning/dashboard.aspx) 然後點擊「開始以前安排的線上督導測驗」。您將會重新導向到 Pearson VUE 頁面，在此頁面您會看到所排定的測驗，然後就可以開始測驗。
